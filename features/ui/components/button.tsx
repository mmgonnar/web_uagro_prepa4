...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          'bg-main-red text-primary-foreground shadow-xs hover:bg-secondary-red cursor-pointer',
        destructive:
        ...
        outline:
          'hover:bg-main-red m-auto my-4 flex w-full cursor-pointer items-center justify-center rounded-md border-1 border-neutral-300 px-4 py-1 text-center text-neutral-600 transition-colors hover:text-white',
        secondary:
          'bg-main-bue text-secondary-foreground shadow-xs hover:bg-white cursor-pointer',
        ghost: ' hover:text-main-red cursor-pointer',
